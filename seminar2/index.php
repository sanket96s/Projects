...
<body>
    <nav id="navbar">
        <span id="mode">
            <button id="button-1" onclick="darkMode()"><img src="dark.png" alt="DarkMode"></button>
            <button id="button-2" onclick="lightMode()"><img src="light.png" alt="LightMode"></button>
        </span>
        <header id="header">JS Documentation</header>
        <ul>
            <li><a href="#section1" id="nav-link1">Introduction</a>
            </li>
            <li><a href="#section2" id="nav-link2">What you should know</a>
            </li>
            <li><a href="#section3" id="nav-link3">JavaScript and Java</a>
            </li>
            <li><a href="#section4" id="nav-link4">Hello world</a>
            </li>
            <li><a href="#section5" id="nav-link5">Variables</a>
            </li>
            <li><a href="#section6" id="nav-link6">Declaring variables</a>
            </li>
            <li><a href="#section7" id="nav-link7">Variable scope</a>
            </li>
            <li><a href="#section8" id="nav-link8">Global variables</a>
            </li>
            <li><a href="#section9" id="nav-link9">Constants</a>
            </li>
            <li><a href="#section10" id="nav-link10">Data types</a>
            </li>
            <li><a href="#section11" id="nav-link11">if..else statement</a>
            </li>
            <li><a href="#section12" id="nav-link12">while statement</a>
            </li>
            <li><a href="#section13" id="nav-link13">Function declaration</a>
            </li>
            <li><a href="#section14" id="nav-link14">Reference</a>
            </li>
        </ul>
    </nav>
    <main id="main-doc">
        <section class="main-section" id="section1">
            <header id="heading1">Introduction</header>
            <article>
                ...
                <ul>
                    <li>
                        <p>Client-side JavaScript extends the core language by supplying objects to control a browser
                            ...
                            clicks, form input, and page navigation.</p>
                    </li>
                    <li>
                        <p>Server-side JavaScript extends the core language by supplying objects relevant to running
                            ...
                            another of the application, or perform file manipulations on a server.</p>
                    </li>
                </ul>
            </article>
        </section>
        <section id="section2">
            <header id="heading2">What you should already know</header>
            <article>
                ...
                <ul>
                    ...
                    <li>
                        <p>Some programming experience. If you are new to programming, try one of the tutorials linked
                            on the main page about JavaScript.</p>
                    </li>
                </ul>
            </article>
        </section>
        <section id="section3">
            <header id="heading3">Javascript and Java</header>
            <article>
        ...
        <section id="section4">
            <header id="heading4">Hello world</header>
            <article>
                <p>To get started with writing JavaScript, open the Scratchpad and write your first "Hello world"
                    JavaScript code:</p>
                <code id="code1">function greetMe(yourName) { alert("Hello " + yourName); }
                        greetMe("World");
                </code>
        ...
        <section id="section5">
            <header id="heading5">Variables</header>
            <article>
        ...
        <section id="section7">
            ...
            <article>
                ...
                <code id="code5">if (true) { var x = 5; } console.log(x); // 5</code>
                <p>This behavior changes, when using the let declaration introduced in ECMAScript 2015.</p>
                <code id="code6">if (true) { let y = 5; } console.log(y); // ReferenceError: y is
                    not defined</code>
            </article>
        </section>
        <section id="section8">
            <header id="heading8">Global variables</header>
            <article>
        ...
        <section id="section9">
            <header id="heading9">Constants</header>
            <article>
                ...
                <code id="code7">const PI = 3.14;</code>
                ...
                <p>You cannot declare a constant with the same name as a function or variable in the same scope. For
                    example:</p>
                <code id="code8">// THIS WILL CAUSE AN ERROR function f() {}; const f = 5; // THIS
                    WILL CAUSE AN ERROR ALSO function f() { const g = 5; var g;
                    //statements }</code>
                <p>However, object attributes are not protected, so the following statement is executed without
                    problems.
                </p>
                <code id="code9">const MY_OBJECT = {"key": "value"}; MY_OBJECT.key =
                    "otherValue";</code>
            </article>
        </section>
        <section id="section10">
            <header id="heading10">Data types</header>
            <article>
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <p>null. A special keyword denoting a null value. Because JavaScript is case-sensitive,
                                    null
                                    is not the same as Null, NULL, or any other variant.</p>
                            </li>
                            <li>
                            ...
                            <li>
                                <p>Symbol (new in ECMAScript 2015). A data type whose instances are unique and
                                    immutable.
                                </p>
                            </li>
                        </ul>
        ...
        <section id="section11">
            <header id="heading11">If..else statement</header>
            <article>
                ...
                <code id="code10">if (condition) { statement_1; } else { statement_2; }</code>
                ...
                <p>You may also compound the statements using else if to have multiple conditions tested in sequence, as
                    follows:</p>
                <code id="code11">if (condition_1) { statement_1; } else if (condition_2) {
                ...
                <code id="code12">if (condition) { statement_1_runs_if_condition_is_true;
                ...
                <code id="code13">if (x = y) { /* statements here */ }</code>
                ...
                <code id="code14">if ((x = y)) { /* statements here */ }</code>
            </article>
        </section>
        <section id="section12">
            <header id="heading12">While statement</header>
            <article>
                ...
                <code id="code15">while (condition) statement</code>
                ...
                <code id="code16">var n = 0; var x = 0; while (n < 3) { n++; x +=n; }</code>
        ...
        <section id="section13">
            <header id="heading13">Function declaration</header>
            <article>
                ...
                <code id="code17">function square(number) { return number * number; }</code>
                ...
                <code id="code18">return number * number;</code>
        ...
        <section id="section14">
            <header id="heading14">References</header>
            <article>
                <ul>
                    <li>
        ...
        <section id="section15">
            <header id="heading15">Contact Us</header>
